...
st.title('🏁 Bienvenidos al dashboard de la Formula 1')
...
A través de tres secciones, podrás acceder a mapas y gráficos que te permitirán visualizar el desarrollo de una temporada de Formula 1.""")
...
st.write("### 3. Carreras:")
st.write("""Aquí encontrarás análisis más detalaldos de cada carrera, donde podrás visualizar:""")
st.markdown("""
**- Gráficos de cambios de posición:** Observa cómo cambian las posiciones a lo largo de una carrera y conocer también las posiciones ganas y/o perdidas por los pilotos considerando la posición inicial y final.
